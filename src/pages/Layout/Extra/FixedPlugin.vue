    ...
    <div class="dropdown show-dropdown" :class="{ show: isOpen }">
      ...
      <ul class="dropdown-menu" :class="{ show: isOpen }">
        ...
        <li class="github-buttons">
          <gh-btns-star
            slug="https://github.com/Attila9800"
            show-count
          ></gh-btns-star>
        </li>
      </ul>
...
export default {
  data() {
    return {
      documentationLink: "https://www.instagram.com/edil.attila/",
      shareUrl: "https://www.instagram.com/edil.attila/",
      buyUrl: "",
      freeUrl: "https://www.instagram.com/edil.attila/",
      isOpen: false,
      sidebarColors: [
